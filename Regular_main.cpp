...
int main(int argc, char* argv[])
{
	...
	Eigen::initParallel();
	Control control;//the control tags. 
	...
	if (control.fitting_needed)
	{
		...
		Hamiltonian_regular hamiltonian(atoms,linear_k_points_fit,parameters,control.max_neighbor_order_for_band_calculation);
	...
	{
		Hamiltonian_regular hamiltonian(atoms,linear_k_points,parameters,control.max_neighbor_order_for_band_calculation);//calculate the hamiltonian. 
	}
	if (control.SOC_calculation_needed)
	{
		Hamiltonian_SOC hamiltonian_SOC(atoms,linear_k_points,parameters,control.max_neighbor_order_for_band_calculation);//calculate the hamiltonian. 
	}
	if (control.DOS_calculation_needed)
	{
		K_points_grid k_points_grid(control.k_mesh_num);
		Hamiltonian_regular hamiltonian(atoms,k_points_grid,parameters,control.max_neighbor_order_for_band_calculation);
